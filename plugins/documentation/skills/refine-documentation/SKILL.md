...
description: "Refine and improve existing brainstorm or plan documents through structured review. Use for documentation refinement, editing for clarity, restructuring content, and improving document quality before proceeding to the next workflow step. Scope: document review and refinement only -- not creating new documents."
---
...
**If no document is specified:** Ask which document to review, or look for the most recent brainstorm/plan in the project's brainstorms or plans directories.
...
If invoked within a workflow (after a brainstorm or plan step), also check:
