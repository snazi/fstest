---
name: compounding-documentation
description: "Capture solved problems as categorized documentation with YAML frontmatter for fast lookup. Use for compounding documentation, knowledge accumulation, incident pattern tracking, solution writeups, and building searchable institutional knowledge bases from resolved issues. Scope: problem-solution documentation only -- not feature docs, architecture docs, or MOPs."
---

# compounding-documentation Skill
...
All projects using this skill follow this documentation layout.

### Directory Structure

```text
docs/
├── overview.md              # Project overview (always loaded by AI agents)
├── apis/                    # API documentation
├── features/                # End-to-end feature documentation
├── getting-started/         # Onboarding and setup guides
├── handover/                # Knowledge-transfer documentation
├── models/                  # Data model documentation
├── mops/                    # Mode-of-procedure operational guides
└── solutions/               # Issue investigations and solution writeups
```

### Solutions Category Directories

```text
docs/solutions/
├── patterns/
│   └── critical-patterns.md   # Must-read patterns promoted from high-severity issues
├── build-errors/
├── test-failures/
├── runtime-errors/
├── performance-issues/
...
### `problem_type` Values and Category Mapping
...
Project-specific `component` and `root_cause` enum values are defined in `references/yaml-schema.md` and validated against `schema.yaml`.
...
2. Create initial reference files with this solution as first example
3. Confirm: "Created new [skill-name] skill with this solution as first example"
