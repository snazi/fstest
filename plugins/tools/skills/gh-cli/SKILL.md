---
name: gh-cli
description: "GitHub CLI (gh) comprehensive reference for repositories, issues, pull requests, Actions workflows, projects, releases, gists, codespaces, organizations, extensions, secrets, variables, rulesets, and all GitHub API operations from the command line. Use when the user needs to interact with GitHub, create PRs, manage issues, run workflows, search code, manage releases, or perform any GitHub operation via the gh CLI. This skill does NOT cover non-GitHub hosting platforms."
---
