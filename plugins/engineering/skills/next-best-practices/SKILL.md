...
description: "Next.js best practices for App Router, React Server Components (RSC), TypeScript, file conventions, async patterns, metadata, error handling, route handlers, image and font optimization, bundling, hydration errors, suspense boundaries, parallel routes, and self-hosting. Use when writing, reviewing, or debugging Next.js applications. Do not use for backend-only Python or non-Next.js React projects."
---
